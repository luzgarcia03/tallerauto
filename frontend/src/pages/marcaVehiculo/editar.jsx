...
const MarcaVehiculoEditar = () => {
  ...
  const handleSubmit = e => {
    e.preventDefault();
    api.put(`/marcas-vehiculo/${id}`, form)
      .then(() => {
        alert('Marca actualizada con éxito');
        navigate('/marca-vehiculo');
      })
      .catch(() => alert('Error al actualizar marca'));
  };
    ...
    <div className="container mt-4">
      <div className="card">
        <div className="card-header bg-warning text-white d-flex justify-content-between align-items-center">
          <h4 className="mb-0"><i className="fas fa-edit me-2"></i>Editar Marca</h4>
...
export default MarcaVehiculoEditar;
