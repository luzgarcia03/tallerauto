...
const TipoVehiculoEditar = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const [form, setForm] = useState(null);

  useEffect(() => {
    api.get(`/tipos-vehiculo/${id}`)
  ...
  const handleSubmit = e => {
    e.preventDefault();
    api.put(`/tipos-vehiculo/${id}`, form)
      .then(() => {
    ...
    <div className="container mt-4">
      <div className="card">
        <div className="card-header bg-warning text-white d-flex justify-content-between align-items-center">
          <h4 className="mb-0"><i className="fas fa-edit me-2"></i>Editar Tipo</h4>
        ...
        <div className="card-body">
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <input type="text" name="nombre_tipo" className="form-control" value={form.nombre_tipo} onChange={handleChange} required />
            </div>
            <div className="mb-3">
...
export default TipoVehiculoEditar;
