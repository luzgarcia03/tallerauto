...
exports.obtenerEstadosPago = async (req, res) => {
  try {
...
exports.obtenerEstadoPagoPorId = async (req, res) => {
    try {
      const { id } = req.params;
      const estado = await EstadoPago.findByPk(id);
...
exports.crearEstadoPago = async (req, res) => {
  try {
    const nuevoEstado = await EstadoPago.create(req.body);
...
exports.actualizarEstado = async (req, res) => {
  try {
    const estado = await EstadoPago.findByPk(req.params.id);
